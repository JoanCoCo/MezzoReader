...
static Symbol CROTCHET_SILENCE = Symbol(CROTCHET_SILENCE_TEMPLATE, 3.0f, 0.0f, 0.86, CROTCHET_SILENCE_ID, true);
...
static Symbol QUAVER_SILENCE = Symbol(QUAVER_SILENCE_TEMPLATE, 2.0f, 0.0f, 0.901, QUAVER_SILENCE_ID, true);
